...
namespace BSD.C4.Tlaxcala.Sai.Dal.Rules.Objects
{
    ...
    public partial class UsuarioObject : BaseObject, IMappeableUsuarioObject, IUniqueIdentifiable, IEquatable<UsuarioObject>, ICloneable
    {
        ...
        public UsuarioObject(
			...
			System.Nullable<System.Boolean> Despachador): base()
        {
...
///
/// </summary>
protected System.Nullable<System.Boolean> _Despachador;
        ...
        /// Nullable property
        /// </summary>
        public virtual System.Nullable<System.Boolean> Despachador
        {
            get
            {
                return _Despachador;
...
if (_Despachador.HasValue) _myArray[5] = _Despachador.Value;
