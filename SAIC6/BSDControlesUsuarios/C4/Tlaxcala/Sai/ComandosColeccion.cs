            ...
            return new List<Comando>
                       {
                           ...
                           new Comando(ID.CMD_PH, "PH", "Historial de incidentes con la misma dirección.", null, false,
                                       true),
                           new Comando(ID.CMD_RPH, "RPH", "Historial de incidentes con el mismo número telefónico.",
                                       null, false, true),
                           ...
                           new Comando(ID.CMD_TEL, "TEL", "Mostrar agenda telefónica de las instituciones del estado.",
                                       'T', false, true),
                           new Comando(ID.CMD_U, "U", "Unidades de las distintas corporaciones.", 'U', false, true),
                           new Comando(ID.CMD_M, "M", "Muestra el mapa para la referenciación geográfica del incidente.",
                                       'M', false, true)
                       };
        }
    }
