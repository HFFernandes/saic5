...
{
    public partial class SAIFrmIncidenciasActivas089 : SAIFrmBase
    {
        ...
        public SAIFrmIncidenciasActivas089()
        {
            InitializeComponent();
        ...
        void btnVistaPrevia_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    saiReport1.reportControl.PrintPreviewOptions.Title = "Reporte de Incidencias Activas 089";
        ...
        private void SAIFrmIncidenciasActivas089_Load(object sender, EventArgs e)
        {
