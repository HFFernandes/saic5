...
// This is a partial class file. The other one is CorporacionGateway.Auto.cs
...
namespace BSD.C4.Tlaxcala.Sai.Dal.Rules.Gateways
{
    ...
    /// <summary>
    /// Gateway between CorporacionObject class and Corporacion table.
    /// This class provide CRUD methods for Corporacion table.
    /// </summary>
    public partial class CorporacionGateway
    {
        ...
        // /// </summary>
        //protected override bool CheckForSecurityRights(SecurityRights action, CorporacionObjectList ObjectListOrEntityList)
        //{
        //    switch (action)
        //    {
