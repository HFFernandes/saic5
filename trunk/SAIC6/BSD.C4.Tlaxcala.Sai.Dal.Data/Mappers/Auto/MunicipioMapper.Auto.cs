...
(reader.IsDBNull(2)) ? "" : reader.GetString(2));
        ...
        /// 
        /// </summary>
        public Municipio GetOne(System.Int32 Clave)
        {
            return base.GetOne(new Municipio(Clave));
        }
        ...
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(StoredProceduresPrefix() + "Municipio_Delete", Clave);
        }
        ...
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(transaction, StoredProceduresPrefix() + "Municipio_Delete", Clave);
        }
...
namespace BSD.C4.Tlaxcala.Sai.Dal.Rules.Wrappers
{
    ...
    public class MunicipioMapperWrapper
    {
        ...
        /// </summary>
        public Entities.Municipio GetOne(System.Int32 Clave) {
        ...
        public void Save(System.Int32 Clave, System.Int32 ClaveEstado, System.String Nombre){
            Entities.Municipio entity = Instance().GetOne(Clave);
            if (entity == null)
...
(reader.IsDBNull(2)) ? "" : reader.GetString(2));
        ...
        {
            return base.GetObjectByAnyStoredProcedure(StoredProceduresPrefix() + "Municipio_GetOne", Clave);
        }
