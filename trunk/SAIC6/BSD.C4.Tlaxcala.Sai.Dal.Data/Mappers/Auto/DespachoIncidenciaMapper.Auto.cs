...
reader.GetInt32(8));
        ...
        /// 
        /// </summary>
        public DespachoIncidenciaList GetByUnidad(DbTransaction transaction, IUniqueIdentifiable Unidad)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad", Unidad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public DespachoIncidenciaList GetByUnidad2(DbTransaction transaction, System.Int32 ClaveUnidadApoyo)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad2", ClaveUnidadApoyo);
        }

        /// <summary>
        /// 
        /// </summary>
        public DespachoIncidenciaList GetByUnidad2(DbTransaction transaction, IUniqueIdentifiable Unidad)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad2", Unidad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public DespachoIncidenciaList GetByUnidad(IUniqueIdentifiable Unidad)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad", Unidad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public DespachoIncidenciaList GetByUnidad2(System.Int32 ClaveUnidadApoyo)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad2", ClaveUnidadApoyo);
        }

        /// <summary>
        /// 
        /// </summary>
        public DespachoIncidenciaList GetByUnidad2(IUniqueIdentifiable Unidad)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad2", Unidad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public void DeleteByUnidad(IUniqueIdentifiable Unidad)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_DeleteByUnidad", Unidad.Identifier());
        }

        /// <summary>
        /// 
        /// </summary>
        public void DeleteByUnidad(DbTransaction transaction, IUniqueIdentifiable Unidad)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_DeleteByUnidad", Unidad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public void DeleteByUnidad2(System.Int32 ClaveUnidadApoyo)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_DeleteByUnidad2", ClaveUnidadApoyo);
        }

        /// <summary>
        /// 
        /// </summary>
        public void DeleteByUnidad2(DbTransaction transaction, System.Int32 ClaveUnidadApoyo)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_DeleteByUnidad2", ClaveUnidadApoyo);
        }
        ...
        /// 
        /// </summary>
        public void DeleteByUnidad2(IUniqueIdentifiable Unidad)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_DeleteByUnidad2", Unidad.Identifier());
        }

        /// <summary>
        /// 
        /// </summary>
        public void DeleteByUnidad2(DbTransaction transaction, IUniqueIdentifiable Unidad)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_DeleteByUnidad2", Unidad.Identifier());
        }
...
namespace BSD.C4.Tlaxcala.Sai.Dal.Rules.Wrappers
{
    ...
    public class DespachoIncidenciaMapperWrapper
    {
        ...
        /// Get a DespachoIncidenciaList by calling a Stored Procedure
        /// </summary>
        public Entities.DespachoIncidenciaList GetByUnidad(IUniqueIdentifiable Unidad)
        {
            return Instance().GetByUnidad(Unidad);
        }
        ...
        /// Get a DespachoIncidenciaList by calling a Stored Procedure
        /// </summary>
        public Entities.DespachoIncidenciaList GetByUnidad2(System.Int32 ClaveUnidadApoyo)
        {
            return Instance().GetByUnidad2(ClaveUnidadApoyo);
        }

        /// <summary>
        /// Get a DespachoIncidenciaList by calling a Stored Procedure
        /// </summary>
        public Entities.DespachoIncidenciaList GetByUnidad2(IUniqueIdentifiable Unidad)
        {
            return Instance().GetByUnidad2(Unidad);
        }
        ...
        public void DeleteByUnidad(IUniqueIdentifiable Unidad)
        {
            Instance().DeleteByUnidad(Unidad);
        }

    

        /// <summary>
        /// Delete DespachoIncidencia by Unidad2
        /// </summary>
        public void DeleteByUnidad2(System.Int32 ClaveUnidadApoyo)
        {
            Instance().DeleteByUnidad2(ClaveUnidadApoyo);
        }
        ...
        public void DeleteByUnidad2(IUniqueIdentifiable Unidad)
        {
            Instance().DeleteByUnidad2(Unidad);
        }
...
reader.GetInt32(8));
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByUnidad(DbTransaction transaction, IUniqueIdentifiable Unidad)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad", Unidad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByUnidad2(DbTransaction transaction, System.Int32 ClaveUnidadApoyo)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad2", ClaveUnidadApoyo);
        }
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByUnidad2(DbTransaction transaction, IUniqueIdentifiable Unidad)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad2", Unidad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByUnidad(IUniqueIdentifiable Unidad)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad", Unidad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByUnidad2(System.Int32 ClaveUnidadApoyo)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad2", ClaveUnidadApoyo);
        }
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByUnidad2(IUniqueIdentifiable Unidad)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "DespachoIncidencia_GetByUnidad2", Unidad.Identifier());
        }
