...
namespace BSD.C4.Tlaxcala.Sai.Dal.Rules.Objects
{
    ...
    public partial class VehiculoObject : BaseObject, IMappeableVehiculoObject, IUniqueIdentifiable, IEquatable<VehiculoObject>, ICloneable
    {
        ...
        public VehiculoObject(
			...
			System.String NumeroMotor): base()
        {
...
/// 
/// </summary>
protected System.String _NumeroMotor;
        ...
        /// 
        /// </summary>
        public virtual System.String NumeroMotor
        {
            get
            {
                return _NumeroMotor;
...
if (!System.String.IsNullOrEmpty(_NumeroMotor)) _myArray[8] = _NumeroMotor;
